...
namespace Abstract04
{
    ...
    {
        public HoaDonKhachVangLai(string maHang, string tenHang, float donGia, string maSo, string hoTen, string ngayLap, string matHang, int soLuong) : base(maHang, tenHang, donGia, maSo, hoTen, ngayLap, matHang, soLuong)
        {
            MaHang = maHang;
            TenHang = tenHang;
            DonGia = donGia;
